...
import com.doublej.jjfitnessapp.ui.models.nutrition.PlanFoodThursday


class ThursdayFoodRecyclerAdapter(var plan_foods : ArrayList<PlanFoodThursday>) : ListAdapter<PlanFoodThursday, ThursdayFoodRecyclerAdapter.ViewHolder>(
    ExerciseDiffUtil()
) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val plan_exercises : PlanFoodThursday = getItem(position)
    ...
    class ExerciseDiffUtil : DiffUtil.ItemCallback<PlanFoodThursday>(){
        override fun areItemsTheSame(oldItem: PlanFoodThursday, newItem: PlanFoodThursday): Boolean {
            return oldItem.id === newItem.id
        }

        override fun areContentsTheSame(oldItem: PlanFoodThursday, newItem: PlanFoodThursday): Boolean {
