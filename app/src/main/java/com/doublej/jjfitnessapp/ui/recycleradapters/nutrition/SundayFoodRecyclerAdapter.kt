...
import com.doublej.jjfitnessapp.ui.models.nutrition.PlanFoodSunday



class SundayFoodRecyclerAdapter(var plan_foods : ArrayList<PlanFoodSunday>) : ListAdapter<PlanFoodSunday, SundayFoodRecyclerAdapter.ViewHolder>(
    ExerciseDiffUtil()
) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val plan_exercises : PlanFoodSunday = getItem(position)
    ...
    class ExerciseDiffUtil : DiffUtil.ItemCallback<PlanFoodSunday>(){
        override fun areItemsTheSame(oldItem: PlanFoodSunday, newItem: PlanFoodSunday): Boolean {
            return oldItem.id === newItem.id
        }

        override fun areContentsTheSame(oldItem: PlanFoodSunday, newItem: PlanFoodSunday): Boolean {
