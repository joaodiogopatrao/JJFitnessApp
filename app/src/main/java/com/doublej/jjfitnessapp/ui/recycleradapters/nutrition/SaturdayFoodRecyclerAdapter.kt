...
import com.doublej.jjfitnessapp.ui.models.nutrition.PlanFoodSaturday



class SaturdayFoodRecyclerAdapter(var plan_foods : ArrayList<PlanFoodSaturday>) : ListAdapter<PlanFoodSaturday, SaturdayFoodRecyclerAdapter.ViewHolder>(
    ExerciseDiffUtil()
) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val plan_exercises : PlanFoodSaturday = getItem(position)
    ...
    class ExerciseDiffUtil : DiffUtil.ItemCallback<PlanFoodSaturday>(){
        override fun areItemsTheSame(oldItem: PlanFoodSaturday, newItem: PlanFoodSaturday): Boolean {
            return oldItem.id === newItem.id
        }

        override fun areContentsTheSame(oldItem: PlanFoodSaturday, newItem: PlanFoodSaturday): Boolean {
